...
# When we ran `secure_function`, we checked the user's access level. Because at that
# point the user was not an admin, the function did not `return func`. Therefore `get_admin_password` is set to `None`.
